...
KOBJS := assert.o main.o math.o memcheck.o raise.o ctype.o hexdump.o device.o stack_setup.o new_swi.o new_c_swi.o new_c_irq.o timer_driver.o setup_irq_stack.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
